...
import (
	...
	operatorv1alpha1 "github.com/sap/component-operator-runtime/examples/helm/api/v1alpha1"
)

const Name = "helmcomponent-operator.example.io"
...
func (o *Operator) GetUncacheableTypes() []client.Object {
	...
	return []client.Object{&operatorv1alpha1.HelmComponent{}}
}
...
func (o *Operator) Setup(mgr ctrl.Manager, discoveryClient discovery.DiscoveryInterface) error {
	...
	if err := component.NewReconciler[*operatorv1alpha1.HelmComponent](
		o.options.Name,
		mgr.GetClient(),
		discoveryClient,
